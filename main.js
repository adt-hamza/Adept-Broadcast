...
// bot token
var token = "NzMzNzQxNDUyODY1MDQ0NTgy.XxI2Ug.SvQTz_NJY6ugHW2KgSEgk69_xB4";
// Abréviation utilisée dans les commandes
const prefix = "$";
// activité du bot
			...
			switch(command)
			{
				case "help":
					if(message.member.hasPermission(Discord.Permissions.ALL))
					{
						...
						message.reply("hey sir! I DMed you with my current abilities.");
					}
					else
					{
